...
// Отдаём саму HTML-страницу сайта (public/index.html) как статику.
// Благодаря этому сайт и API живут на одном Railway-домене.
...
// Отдаёт то, что было записано последним POST-запросом, без пересчёта.
...
// Простой healthcheck (не пересекается с "/", там теперь сайт)
